...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from 'smartswap-sdk-core'
import { encodeRouteToPath, MethodParameters, toHex } from './utils'
import IQuoter from 'smartswap-v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
import IQuoterV2 from 'smartswap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'
