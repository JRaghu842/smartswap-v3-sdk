...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from 'smartswap-sdk-core'
...
import ISwapRouter from 'smartswap-v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
