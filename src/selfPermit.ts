import { BigintIsh, Token } from 'smartswap-sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from 'smartswap-v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
